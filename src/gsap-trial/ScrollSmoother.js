...
let e, t, r, o, s, i, n, a, l, c, d, h, f, g, p, u = () => "undefined" != typeof window, m = () => e || u() && (e = window.gsap) && e.registerPlugin && e, v = function () {
    ...
    ("undefined" != typeof window ? window.location.host : ""), e => l.maxScroll(e || r)), T = e => {
        ...
        return t || (t = o.createElement("div"), t.classList.add("ScrollSmoother-wrapper"), e.parentNode.insertBefore(t, e), t.appendChild(e)),
            t
    };
class x {
    constructor(u) {
        ...
        let m,
            ...
            oe = e => {
                v.scrollTop = 0,
                    e.target.contains && e.target.contains(v) || O && !1 === O(this, e) || (l.isInViewport(e.target) || e.target === z || this.scrollTo(e.target, !1, "center center"), z = e.target)
            },
            se = (e, t) => {
                if (e < t.start)
                    return e;
                ...
                for (d = 0; d < r.length; d++)
                    if (h = r[d], t.trigger && h.trigger && t !== h && (h.trigger === t.trigger || h.pinnedContainer === t.trigger || t.trigger.contains(h.trigger)) && (l = h._startNative || h._startClamp || h.start, c = h._endNative || h._endClamp || h.end, n = se(l, t), a = h.pin && c > 0 ? n + (c - l) : se(c, t), h.setPositions(n, a, !0, (h._startClamp ? Math.max(0, n) : n) - l), h.markerStart && g.push(e.quickSetter([h.markerStart, h.markerEnd], "y", "px")), h.pin && h.end > 0 && !o)) {
                        if (s = h.end - h.start, i = t._startClamp && h.start < 0, i) {
                            if (t.start > 0)
                                return t.setPositions(0, t.end + (t._startNative - t.start), !0), void ie(t, r);
                            s += h.start,
                                f.offset = -h.start
                        }
                        f.push({
            ...
            ae = () => {
                X(),
                    ...
                    b && (l.getAll().forEach(e => {
                        ...
                        e._startClamp && t < 0 ? (r = e.ratio < 0 ? S() : e.end / e.ratio, o = r - e.end, t = 0) : (e.ratio < 0 || e._endClamp && r >= S()) && (r = S(), t = e.ratio < 0 || e.ratio > 1 ? 0 : r - (r - e.start) / e.ratio, o = (r - t) * e.ratio - (e.end - e.start)),
                            e.offset = o || 1e-4,
            ...
            fe = (t, o, i, n, c) => {
                ...
                let h,
                    ...
                    C = () => {
                        o = y(),
                            ...
                            g = "auto" === o.value,
                            u = g || f && f._startClamp && f.start <= 0 || _.offset ? 0 : f && f._endClamp && f.end === S() ? 1 : .5,
                            p && p.kill(),
                            p = i && e.to(t, {
                                ease: d,
                                overwrite: !1,
                    ...
                    k = e => {
                        if (g) {
                            ...
                            m = _.offset || 0, R = (e.end - e.start - m) * (1 - h);
                ...
                return C(),
                                ...
                                if (n) {
                                    for (o = -Y, s = t.end; n--;) {
                                        if (r = _[n], r.trig.isActive || o >= r.start && o <= r.end)
                                            return void (p && (r.trig.progress += r.trig.direction < 0 ? .001 : - .001, r.trig.update(0, 0, 1), p.resetTo("y", parseFloat(x.y), -K, !0), $ && p.progress(1)));
                    ...
                    }), k(f), e.core.getCache(f.trigger).stRevert = de, f.startY = T, f.pins = _, f.markers = P, f.ratio = h, f.autoSpeed = g, t.style.willChange = "transform"),
                    f
            };
        function ge() {
        ...
        le(),
            ...
            this.sections = (e, t) => {
                ...
                return t && t.add ? _.push(...r) : _ = r.slice(0),
                    r
            },
        ...
        pe.forEach(e => e.revert(!0, !0)),
            w = l.create({
                ...
                onRefreshInit: e => {
                    ...
                    N = t && t._end > t._dp._time,
                        A = Y,
                        Q.y = 0,
                        D && (1 === l.isTouch && (v.style.position = "absolute"), v.scrollTop = 0, 1 === l.isTouch && (v.style.position = "fixed"))
                },
                onRefresh: t => {
            ...
            I && (this.normalizer = l.normalizeScroll(!0 === I ? {
                debounce: !0,
                content: !D && m
            }
                : I)),
    ...
    static register(v) {
        return t || (e = v || m(), u() && window.document && (r = window, o = document, s = o.documentElement, i = o.body), e && (n = e.utils.toArray, a = e.utils.clamp, d = e.parseEase("expo"), g = e.core.context || function () { }, l = e.core.globals().ScrollTrigger, e.core.globals("ScrollSmoother", x), i && l && (p = e.delayedCall(.2, () => l.isRefreshing || c && c.refresh()).pause(), h = l.core._getVelocityProp, f = l.core._inputObserver, x.refresh = l.refresh, t = 1))),
            t
    }
}
