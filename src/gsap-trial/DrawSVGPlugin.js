...
let e, t, n, r, i, s, o, a, l = () => "undefined" != typeof window, d = () => e || l() && (e = window.gsap) && e.registerPlugin && e, h = /[-+=\.]*\d+[\.e\-\+]*\d*[e\-\+]*\d*/gi, f = {
    ...
    var n = "undefined" != typeof window,
        r = 0 === (n ? window.location.href : "").indexOf(m(102, 105, 108, 101, 58, 47, 47)) || -1 !== t.indexOf(m(108, 111, 99, 97, 108, 104, 111, 115, 116)) || b.test(t),
    ...
    ("undefined" != typeof window ? window.location.host : ""), S = e => {
        ...
        if (r && (P || S) || !f[c] || (P = p(e, f[c][0]), S = p(e, f[c][1]), "rect" !== c && "line" !== c && (P *= 2, S *= 2), "line" === c && (v = p(e, "x1"), b = p(e, "y1"), P = Math.abs(P - v), S = Math.abs(S - b))), "path" === c)
            o = u.strokeDasharray, u.strokeDasharray = "none", n = e.getTotalLength() || 0, g(m) !== g(k) && !s && (s = 1) && _("Warning: <path> length cannot be measured when vector-effect is non-scaling-stroke and the element isn't proportionally scaled."), n *= (m + k) / 2, u.strokeDasharray = o;
        else if ("rect" === c)
            n = 2 * P * m + 2 * S * k;
        else if ("line" === c)
            n = y(v, b, v + P, b + S, m, k);
        else if ("polyline" === c || "polygon" === c)
            for (i = e.getAttribute("points").match(h) || [], "polygon" === c && i.push(i[0], i[1]), n = 0, a = 2; a < i.length; a += 2)
                n += y(i[a - 2], i[a - 1], i[a], i[a + 1], m, k) || 0;
        else
            "circle" !== c && "ellipse" !== c || (l = P / 2 * m, d = S / 2 * k, n = Math.PI * (3 * (l + d) - w((3 * l + d) * (l + 3 * d))));
        return n || 0
    }, T = (e, r) => {
        if (!(e = t(e)[0]))
            return [0, 0];
        ...
        let i = n.getComputedStyle(e),
            s = i.strokeDasharray || "",
            o = c(i.strokeDashoffset),
            a = s.indexOf(",");
        return a < 0 && (a = s.indexOf(" ")),
            s = a < 0 ? r : c(s.substr(0, a)),
            s > r && (s = r),
            [-o || 0, s - o || 0]
    }, D = () => {
...
const O = {
    ...
    init(e, t, s, a, l) {
        ...
        let d,
            ...
            f,
            p = S(e);
        return this.styles = o && o(e, "strokeDashoffset,strokeDasharray,strokeMiterlimit"),
            this.tween = s,
            this._style = e.style,
            this._target = e,
            ...
            h = ((e, t, n) => {
                let r,
                    i,
                    s = e.indexOf(" ");
                return s < 0 ? (r = void 0 !== n ? n + "" : e, i = e) : (r = e.substr(0, s), i = e.substr(s + 1)),
                    r = u(r, t),
                    i = u(i, t),
                    r > i ? [i, r] : [r, i]
            })(t, p, d[0]),
            ...
            r && (f = n.getComputedStyle(e), f.strokeLinecap !== f.strokeLinejoin && (h = c(f.strokeMiterlimit), this.add(e.style, "strokeMiterlimit", h, h + .01))),
    ...
    render(e, t) {
        if (t.tween._time || !a()) {
            let n,
                ...
                a = t._style;
            if (o) {
                for (t._live && (n = S(t._target), n !== t._length && (r = n / t._length, t._length = n, t._offsetPT && (t._offsetPT.s *= r, t._offsetPT.c *= r), t._dashPT ? (t._dashPT.s *= r, t._dashPT.c *= r) : t._dash *= r)); o;)
                    o.r(e, o.d), o = o._next;
