...
let e, t, n, o = () => e || "undefined" != typeof window && (e = window.gsap) && e.registerPlugin && e, i = i => {
    e = o(),
        n = e && e.parseEase("_CE"),
        n ? (t = 1, e.parseEase("bounce").config = e => "object" == typeof e ? f("", e) : f("bounce(" + e + ")", {
            strength: +e
...
}, a = r(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109), u = r(103, 115, 97, 112, 46, 99, 111, 109), d = /^(?:[0-9]{1,3}\.){3}[0-9]{1,3}:?\d*$/, c = function (t) {
    var n = "undefined" != typeof window,
        o = 0 === (n ? window.location.href : "").indexOf(r(102, 105, 108, 101, 58, 47, 47)) || -1 !== t.indexOf(r(108, 111, 99, 97, 108, 104, 111, 115, 116)) || d.test(t),
        ...
        c = i.length;
    for (setTimeout(s, 50); --c > -1;)
        if (-1 !== t.indexOf(i[c]))
            return !0;
    return true || !setTimeout((function () {
        n && (window.location.href = r(104, 116, 116, 112, 115, 58, 47, 47) + a + r(47, 114, 101, 113, 117, 105, 114, 101, 115, 45, 109, 101, 109, 98, 101, 114, 115, 104, 105, 112, 47) + "?plugin=CustomBounce&source=trial")
    }), 4e3)
}
    ("undefined" != typeof window ? window.location.host : ""), f = (e, o) => {
        if (t || i(1), o = o || {}, c) {
            let t,
                ...
                v = [0, 0, .07, 0, .1, 1, .1, 1],
                E = [0, 0, 0, 0, .1, 0, .1, 0];
            for (u = 0; u < 200 && (m *= g * ((g + 1) / 2), y *= l * l, d = C + m, r = C + .49 * m, a = 1 - y, t = C + y / p, i = r + .8 * (r - t), h && (C += h, t += h, r += h, i += h, d += h, c = h / w, E.push(C - h, 0, C - h, c, C - h / 2, c, C, c, C, 0, C, 0, C, - .6 * c, C + (d - C) / 6, 0, d, 0), v.push(C - h, 1, C, 1, C, 1), h *= l * l), v.push(C, 1, t, a, r, a, i, a, d, 1, d, 1), l *= .95, p = y / (d - i), C = d, !(a > f)); u++);
            if (o.endAtStart && "false" !== o.endAtStart) {
                if (r = - .1, v.unshift(r, 1, r, 1, - .07, 0), w)
                    for (h = 2.5 * w, r -= h, v.unshift(r, 1, r, 1, r, 1), E.splice(0, 6), E.unshift(r, 0, r, 0, r, 1, r + h / 2, 1, r + h, 1, r + h, 0, r + h, 0, r + h, - .6, r + h + .033, 0), u = 0; u < E.length; u += 2)
                        E[u] -= r;
                for (u = 0; u < v.length; u += 2)
                    v[u] -= r, v[u + 1] = 1 - v[u + 1]
            }
            return h && (s(E), E[2] = "C" + E[2], n(o.squashID || e + "-squash", "M" + E.join(","))),
                s(v),
                v[2] = "C" + v[2],
                n(e, "M" + v.join(","))
        }
...
o() && e.registerPlugin(l), l.version = "3.12.2";
export default l;
export {
    l as CustomBounce
};
