...
let t, e, i, r, n, o, s, a, l, c = () => t || "undefined" != typeof window && (t = window.gsap), g = {}, p = t => l(t).id, u = t => g[p("string" == typeof t ? i(t)[0] : t)], d = t => {
    let e,
        i = n;
    if (t - s >= .05)
        for (a = s, s = t; i;)
            e = i.g(i.t, i.p), (e !== i.v1 || t - i.t1 > .2) && (i.v2 = i.v1, i.v1 = e, i.t2 = i.t1, i.t1 = t), i = i._next
}, h = {
    deg: 360,
    rad: 2 * Math.PI
}, f = () => {
    t = c(),
        t && (i = t.utils.toArray, r = t.utils.getUnit, l = t.core.getCache, o = t.ticker, e = 1)
};
class v {
    constructor(t, e, i, n) {
        this.t = t,
...
class m {
    ...
    get(t, e) {
        ...
        return i = parseFloat(e ? s.v1 : s.g(s.t, s.p)),
            r = i - parseFloat(s.v2),
            n = s.rCap,
...
let y, w, _, k, x, T, F, P, N, b, M, O, E, A, C = m.getByTarget, S = () => y || "undefined" != typeof window && (y = window.gsap) && y.registerPlugin && y, j = t => "number" == typeof t, I = t => "object" == typeof t, B = t => "function" == typeof t, R = function () {
    return String.fromCharCode.apply(null, arguments)
}, W = R(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109), L = R(103, 115, 97, 112, 46, 99, 111, 109), U = /^(?:[0-9]{1,3}\.){3}[0-9]{1,3}:?\d*$/, V = function (t) {
    var e = "undefined" != typeof window,
        i = 0 === (e ? window.location.href : "").indexOf(R(102, 105, 108, 101, 58, 47, 47)) || -1 !== t.indexOf(R(108, 111, 99, 97, 108, 104, 111, 115, 116)) || U.test(t),
    ...
    ("undefined" != typeof window ? window.location.host : ""), q = Array.isArray, $ = t => t, z = 1e10, D = (t, e, i) => {
        ...
        if (I(t)) {
            for (; c--;) {
                for (a in o = e[c], s = 0, t)
                    l = o[a] - t[a], s += l * l;
                s < p && (g = c, p = s)
            }
            if ((n || z) < z && n < Math.sqrt(p))
                return t
        } else
            for (; c--;)
                o = e[c], s = o - t, s < 0 && (s = -s), s < p && o >= r && o <= i && (g = c, p = s);
        return e[g]
    }, J = (t, e, i, r, n, o, s) => {
        if ("auto" === t.end)
            return t;
        ...
        if (i = isNaN(i) ? z : i, r = isNaN(r) ? -z : r, I(e)) {
            ...
            a = B(c) ? c(e, s) : q(c) ? H(e, c, i, r, o) : parseFloat(c);
        return a > i ? a = i : a < r && (a = r), {
            max: a,
            min: a,
            unitFactor: t.unitFactor
        }
    }, K = (t, e, i) => isNaN(t[e]) ? i : +t[e], Q = (t, e) => .05 * e * t / b, X = (t, e, i) => Math.abs((e - t) * b / i / .05), Y = {
        resistance: 1,
        checkpoint: 1,
        preventOvershoot: 1,
        linkedProps: 1,
        ...
        if (e.linkedProps) {
            ...
            for (n = 0; n < g.length; n++)
                o = g[n], s = e[o], s && (j(s.velocity) ? a = s.velocity : (l = l || C(t), a = l && l.isTracking(o) ? l.get(o) : 0), c = Math.abs(a / K(s, "resistance", r)), p[o] = parseFloat(i(t, o)) + Q(a, c));
            return p
        }
    }, tt = () => {
        y = S(),
            y && (_ = y.parseEase, k = y.utils.toArray, F = y.utils.getUnit, N = y.core.getCache, M = y.utils.clamp, E = y.core.getStyleSaver, A = y.core.reverting || function () { }, x = _("power3"), b = x(.05), P = y.core.PropTween, y.config({
                resistance: 100,
                unitFactors: {
                    time: 1e3,
                    totalTime: 1e3,
        ...
        let s,
            ...
            b = j(m) ? m : ((t, e, i = 10, r = .2, n = 1, o = 0) => {
                ...
                for (s in f = Z(t, y, w, _), y)
                    Y[s] || (a = y[s], I(a) || (d = d || C(t), d && d.isTracking(s) ? a = j(a) ? {
                        velocity: a
                    }
                        : {
                            velocity: d.get(s)
