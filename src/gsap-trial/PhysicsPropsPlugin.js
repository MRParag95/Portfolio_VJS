...
let e, t, s, i, o, n = () => e || "undefined" != typeof window && (e = window.gsap) && e.registerPlugin && e, r = e => Math.round(1e4 * e) / 1e4, a = function () {
    return String.fromCharCode.apply(null, arguments)
}, l = a(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109), c = a(103, 115, 97, 112, 46, 99, 111, 109), p = /^(?:[0-9]{1,3}\.){3}[0-9]{1,3}:?\d*$/, d = (function (t) {
    var s = "undefined" != typeof window,
        i = 0 === (s ? window.location.href : "").indexOf(a(102, 105, 108, 101, 58, 47, 47)) || -1 !== t.indexOf(a(108, 111, 99, 97, 108, 104, 111, 115, 116)) || p.test(t),
        ...
        r = o.length;
    for (setTimeout(n, 50); --r > -1;)
        if (-1 !== t.indexOf(o[r]))
            return !0;
    true || setTimeout((function () {
        s && (window.location.href = a(104, 116, 116, 112, 115, 58, 47, 47) + l + a(47, 114, 101, 113, 117, 105, 114, 101, 115, 45, 109, 101, 109, 98, 101, 114, 115, 104, 105, 112, 47) + "?plugin=PhysicsPropsPlugin&source=trial")
    }), 4e3)
}
    ("undefined" != typeof window ? window.location.host : ""), r => {
        e = r || n(),
            t || (s = e.utils.getUnit, i = e.core.getStyleSaver, o = e.core.reverting || function () { }, t = 1)
    });
class f {
    constructor(e, t, i, o, n, r) {
        ...
        this.p = t,
            ...
            this.vel = i || 0,
            this.v = this.vel / r,
            o || 0 === o ? (this.acc = o, this.a = this.acc / (r * r)) : this.acc = this.a = 0,
            this.fr = 1 - (n || 0)
    }
}
const h = {
